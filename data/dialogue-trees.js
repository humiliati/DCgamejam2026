 ...
 * 2026-04-18T02:54:04.243Z
 */
var DIALOGUE_TREES_DATA = {
  "_meta": {
    "generated": "2026-04-18T02:54:04.213Z",
      ...
      "nodes": {
        "greeting": {
          ...
          "choices": [
            ...
            {
              "label": "I need to get through that arch",
              "next": "arch"
            },
            {
              "label": "Never mind",
        ...
        "foundry": {
          ...
          "choices": [
            ...
            {
              "label": "I appreciate you talking to me",
              "next": null
            }
          ]
        },
        "how_long": {
          ...
          "choices": [
            {
              "label": "Is there anything to do here?",
              "next": "what_to_do"
            },
            {
              "label": "I should keep moving",
              "next": null
            }
          ]
        },
        ...
        "who_runs": {
          ...
          "choices": [
            {
              "label": "The arch leads to the town?",
              "next": "arch"
            },
            {
              "label": "Thanks",
        ...
        "gleaner": {
          ...
          "choices": [
            {
              "label": "Sounds like my kind of work",
              "next": "work_affirm"
            },
            {
              "label": "That sounds terrible",
              "next": "work_deny"
            }
          ]
        },
      ...
      "nodes": {
        "greeting": {
          ...
          "choices": [
            ...
            {
              "label": "Why are there so many people camping out here?",
              "next": "homelessness"
            },
            {
        ...
        "story": {
          ...
          "choices": [
            {
              "label": "Where did everyone go?",
              "next": "displacement"
            },
            {
              "label": "Can't you find other work?",
              "next": "other_work"
            },
            {
              "label": "That's awful",
        ...
        "nobody_helped": {
          ...
          "choices": [
            {
              "label": "The Admiralty? The Tide?",
              "next": "factions"
            },
            {
              "label": "That's not enough",
              "next": "not_enough"
            }
          ]
        },
        "factions": {
          ...
          "choices": [
            {
              "label": "Who's responsible for all this?",
              "next": "responsible"
            },
            {
              "label": "Back",
        ...
        "gleaner_work": {
          ...
          "choices": [
            {
              "label": "I might sign up for that",
              "next": "sign_up"
            },
            {
              "label": "Back",
        ...
        "homelessness": {
          ...
          "choices": [
            {
              "label": "How many people live out here?",
              "next": "how_many"
            },
            {
              "label": "Who decided that?",
              "next": "responsible"
            },
            {
              "label": "That can't be legal",
              "next": "legal"
            }
          ]
        },
        ...
        "housing": {
          ...
          "choices": [
            {
              "label": "At least they have walls",
              "next": "walls"
            },
            {
              "label": "Back",
      ...
      "nodes": {
        ...
        "okay": {
          ...
          "choices": [
            ...
            {
              "label": "Yes, that's coincidence",
              "next": "coincidence"
            },
            {
              "label": "...I'm going to go",
              "next": "leave"
            }
          ]
        },
        "pandas": {
          ...
          "choices": [
            {
              "label": "I don't see, no",
              "next": "dont_see"
            },
            {
              "label": "Tell me about the dragons",
              "next": "dragons"
            },
            {
              "label": "This is a lot",
        ...
        "dont_see": {
          ...
          "choices": [
            {
              "label": "Who planted the bamboo?",
              "next": "bamboo"
            },
            {
              "label": "I think you need rest",
              "next": "need_rest"
            }
          ]
        },
        "bamboo": {
          ...
          "choices": [
            {
              "label": "Are we still talking about pandas?",
              "next": "still_pandas"
            },
            {
              "label": "Who are the Dragon Elites?",
              "next": "dragons"
            }
          ]
        },
        "still_pandas": {
          ...
          "choices": [
            {
              "label": "You're sitting in a shack",
              "next": "shack"
            },
            {
              "label": "Maybe we're all pandas",
              "next": "all_pandas"
            }
          ]
        },
        ...
        "accountant": {
          ...
          "choices": [
            ...
            {
              "label": "I think the numbers were just numbers",
              "next": "just_numbers"
            }
          ]
        },
        "the_thing": {
          ...
          "choices": [
            ...
            {
              "label": "You sound like you need to talk to someone",
              "next": "need_rest"
            }
          ]
        },
        ...
        "what_happened": {
          ...
          "choices": [
            {
              "label": "You were fired for finding fraud?",
              "next": "fired"
            },
            {
              "label": "That could just be a clerical error",
              "next": "clerical"
            }
          ]
        },
        "fired": {
          ...
          "choices": [
            {
              "label": "The panda was in your dreams?",
              "next": "panda_dream"
            },
            {
              "label": "I'm sorry that happened to you",
              "next": "sorry"
            }
          ]
        },
        "panda_dream": {
          ...
          "choices": [
            {
              "label": "A dragon in a suit",
              "next": "suit_dragon"
            },
            {
              "label": "Have you talked to anyone about this?",
              "next": "need_rest"
            }
          ]
        },
        "suit_dragon": {
          ...
          "choices": [
            {
              "label": "I think this is metaphorical",
              "next": "metaphorical"
            },
            {
              "label": "I don't think I can help you",
              "next": "cant_help"
            }
          ]
        },
        ...
        "not_alone": {
          ...
          "choices": [
            {
              "label": "I have to keep going too",
              "next": "keep_going"
            },
            {
              "label": "Maybe things can change",
              "next": "change"
            }
          ]
        },
        ...
        "change": {
          ...
          "choices": [
            {
              "label": "Then maybe we should be something other than pandas",
              "next": "other"
            },
            {
              "label": "I have to go",
        ...
        "dragons": {
          ...
          "choices": [
            ...
            {
              "label": "I think you've been alone too long",
              "next": "alone"
            }
          ]
        },
        ...
        "patterns": {
          ...
          "choices": [
            {
              "label": "Are you talking about the world or...",
              "next": "meta"
            },
            {
              "label": "I think those are just shrubs",
              "next": "just_shrubs"
            }
          ]
        },
        ...
        "stay": {
          ...
          "choices": [
            {
              "label": "Tell me about the pandas",
              "next": "pandas"
            },
            {
              "label": "Tell me about the dragons",
        ...
        "coincidence": {
          ...
          "choices": [
            ...
            {
              "label": "Okay I really need to go",
              "next": null
            }
          ]
        },
        "soup": {
          ...
          "choices": [
            {
              "label": "I haven't even been to the Bazaar yet",
              "next": "bazaar"
            },
            {
              "label": "...I'm going to leave you to your soups",
              "next": null
            }
          ]
        },
        "bazaar": {
          ...
          "choices": [
            {
              "label": "If I find thirteen soups, I'll remember you",
              "next": "remember"
            },
            {
              "label": "Goodbye",
        ...
        "clerical": {
          ...
          "choices": [
            {
              "label": "What happened after you reported it?",
              "next": "fired"
            },
            {
              "label": "Okay",
    ...
    "floor1_bazaar_vendor": {
      ...
      "nodes": {
        ...
        "entrance": {
          ...
          "choices": [
            {
              "label": "Always nice weather?",
              "next": "weather"
            },
            {
              "label": "I'll check inside",
              "next": null
            }
          ]
        },
      ...
      "nodes": {
        "greeting": {
          ...
          "choices": [
            ...
            {
              "label": "Where's the supply closet?",
              "next": "supplies"
            },
            {
              "label": "Who runs this place?",
              "next": "dispatcher_info"
            },
            {
              "label": "Bye",
              "next": null
        ...
        "contracts": {
          ...
          "choices": [
            {
              "label": "What's the best-paying contract?",
              "next": "best_contract"
            },
            {
              "label": "Back",
    ...
    "watchpost_watchman": {
      ...
      "nodes": {
        "greeting": {
          ...
          "choices": [
            {
              "label": "Where exactly is the rig?",
              "next": "hose_location"
            },
            {
            ...
            {
              "label": "Dispatcher sent me to clean up",
              "next": "dispatched"
            },
            {
              "label": "Just passing through",
        ...
        "hose_preview": {
          ...
          "choices": [
            {
              "label": "Anything else down there?",
              "next": "assignment"
            },
            {
              "label": "Heading out to grab it now",
              "next": "sendoff"
            }
          ]
        },
        "greeting_hose": {
          ...
          "choices": [
            {
              "label": "How does the hose work?",
              "next": "hose_basics"
            },
            {
              "label": "I know how it works",
              "next": "assignment"
            },
            {
              "label": "What happened here?",
        ...
        "hose_basics": {
          ...
          "choices": [
            {
              "label": "What are kinks?",
              "next": "hose_kinks"
            },
            {
              "label": "How do I roll it up?",
              "next": "hose_reel"
            },
            {
              "label": "Good enough. What else?",
              "next": "assignment"
            }
          ]
        },
        ...
        "hose_reel": {
          ...
          "choices": [
            {
              "label": "What about kinks?",
              "next": "hose_kinks"
            },
            {
              "label": "Got it. What else?",
              "next": "assignment"
            }
          ]
        },
        ...
        "door": {
          ...
          "choices": [
            {
              "label": "So the fetch quest was pointless",
              "next": "fetchquest"
            },
            {
              "label": "What do I do now?",
        ...
        "casualties": {
          ...
          "choices": [
            {
              "label": "Ren handled it?",
              "next": "sensitive"
            },
            {
              "label": "Right. What's the job?",
              "next": "assignment"
            }
          ]
        },
        "sensitive": {
          ...
          "choices": [
            {
              "label": "Anything that hums?",
              "next": "hum_hint"
            },
            {
              "label": "What did she leave?",
              "next": "assignment"
            }
          ]
        },
        ...
        "assignment": {
          ...
          "choices": [
            {
              "label": "How do I restock crates?",
              "next": "crates"
            },
            {
              "label": "Where's the hose?",
              "next": "hose_location",
              "showIf": {
                "flag": "hoseDiscovered",
                "value": false
        ...
        "crates": {
          ...
          "choices": [
            ...
            {
              "label": "Good enough. Heading down.",
              "next": "sendoff"
            }
          ]
        },
    ...
    "inn_keeper": {
      ...
      "nodes": {
        ...
        "building": {
          ...
          "choices": [
            {
              "label": "Shipwreck timber?",
              "next": "timber"
            },
            {
              "label": "What’s on the shelves?",
              "next": "bookshelf"
            },
            {
              "label": "Back",
    ...
    "inn_patron_grumpy": {
      ...
      "nodes": {
        ...
        "upset": {
          ...
          "choices": [
            {
              "label": "I can help with the cellar",
              "next": "offer_help"
            },
            {
              "label": "Fair enough",
      ...
      "nodes": {
        ...
        "building": {
          ...
          "choices": [
            ...
            {
              "label": "What are the bookshelves for?",
              "next": "bookshelf"
            },
            {
              "label": "Back",
        ...
        "lore": {
          ...
          "choices": [
            {
              "label": "Before the Compact?",
              "next": "compact"
            },
            {
              "label": "The Foundry is stockpiling?",
              "next": "foundry"
            },
            {
              "label": "Hmm",
      ...
      "nodes": {
        "greeting": {
          ...
          "choices": [
            ...
            {
              "label": "Tell me about the bookshelves",
              "next": "bookshelves"
            },
            {
              "label": "What is the Dragon Compact?",
              "next": "compact_intro"
            },
            {
        ...
        "role": {
          ...
          "choices": [
            {
              "label": "The Tide Council?",
              "next": "tide"
            },
            {
              "label": "You enjoy record-keeping?",
              "next": "enjoy"
            },
            {
              "label": "Back",
        ...
        "bookshelves": {
          ...
          "choices": [
            {
              "label": "Early Compact? How so?",
              "next": "early_compact"
            },
            {
              "label": "I’ll browse them",
              "next": null
            }
          ]
        },
        "early_compact": {
          ...
          "choices": [
            {
              "label": "Dragons were here?",
              "next": "dragons"
            },
            {
              "label": "When did scale trade begin?",
              "next": "scale_trade"
            },
            {
              "label": "Fascinating",
        ...
        "compact_intro": {
          ...
          "choices": [
            ...
            {
              "label": "What does the Compact say?",
              "next": "compact_terms"
            },
            {
              "label": "Who has the original?",
              "next": "vault"
            }
          ]
        },
        "compact_terms": {
          ...
          "choices": [
            {
              "label": "Custodial maintenance... that’s us",
              "next": "thats_us"
            },
            {
        ...
        "if_not": {
          ...
          "choices": [
            {
              "label": "...I should get back to work",
              "next": null
            }
          ]
        },
    ...
    "cellar_resident": {
      ...
      "nodes": {
        "greeting": {
          ...
          "choices": [
            {
              "label": "I'm a Gleaner, yes",
              "next": "relief"
            },
            {
              "label": "What is this building?",
              "next": "building"
            },
            {
              "label": "What's wrong?",
      ...
      "nodes": {
        "greeting": {
          ...
          "choices": [
            ...
            {
              "label": "Why is the gate locked?",
              "next": "why_locked"
            },
            {
              "label": "What’s on the other side?",
              "next": "whats_beyond"
            },
            {
              "label": "I’ll be back",
