 ...
 *
 * Fresh-inode v2 copy. See verify-phase4.js for the canonical source;
 * this mirror exists solely to dodge the bindfs Edit-tool stale-cache
 * gotcha so Node can parse the latest bytes.
 *
 * Usage: node tools/_phase4-cache/verify-phase4-v2.js
 */
'use strict';
...
(function g3() {
  ...
  var row = DF.updateRelationship('npc', 'kessel', 100, 'neutral', {
    icon: '\uD83D\uDC6E', name: 'Sgt Kessel',
    factionId: 'bprd', floor: '1.2'
  });
...
(function g4() {
  ...
  assert('G4', 'meta.tierCrossed routes to df-npc-tiercross class',
