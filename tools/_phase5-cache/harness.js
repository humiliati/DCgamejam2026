/**
 * Phase 5 Node harness (fresh-inode copy of tools/phase5-harness.js).
 * See the original for documentation.  Rewritten to /tmp-style cache
 * path to defeat the bindfs-cached-bytes issue on the canonical path.
 */
'use strict';
...
console.log('\nT8 - count gate skips non-matching events');
{
  ...
  qc.setActive('q.t8');
  qc.onMinigameExit('pressure_wash', 'complete',  {});
  qc.onMinigameExit('lights_out',    'subtarget', {});
  qc.onMinigameExit('pressure_wash', 'subtarget', {});
